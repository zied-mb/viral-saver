...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success("Message sent successfully! Zied will get back to you soon. 🚀");
    }, 1500);
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl group hover:border-pink-500/30 transition-all">
              ...
              <p className="text-sm text-white/40">Zied usually responds within 24 hours via <span className="text-pink-400">Dounzay@gmail.com</span></p>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl">
              ...
              <div className="flex flex-col gap-3">
                <a href="https://zied-meddeb-portfolio.netlify.app/" target="_blank" className="flex items-center gap-3 text-sm text-white/40 hover:text-white transition-all group">
                  <div className="p-2 rounded-lg bg-white/5 group-hover:bg-pink-500/20"><Globe className="w-4 h-4" /></div>
                  Portfolio
                </a>
                <a href="https://github.com/zied-mb" target="_blank" className="flex items-center gap-3 text-sm text-white/40 hover:text-white transition-all group">
                  <div className="p-2 rounded-lg bg-white/5 group-hover:bg-violet-500/20"><Github className="w-4 h-4" /></div>
                  GitHub
                </a>
                <a href="https://www.linkedin.com/in/zied-meddeb-7087a2266/" target="_blank" className="flex items-center gap-3 text-sm text-white/40 hover:text-white transition-all group">
            ...
            <form onSubmit={handleSubmit} className="p-8 md:p-10 space-y-6">
              <div className="space-y-4">
                <div className="relative group">
                  ...
                  <input required type="text" placeholder="Your Name" className="w-full pl-12 pr-5 py-4 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-white/20 focus:outline-none focus:border-pink-500/50 focus:bg-pink-500/5 transition-all" />
                </div>
                ...
                <div className="relative group">
                  ...
                  <input required type="email" placeholder="Email Address" className="w-full pl-12 pr-5 py-4 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-white/20 focus:outline-none focus:border-violet-500/50 focus:bg-violet-500/5 transition-all" />
                </div>

                <div className="relative group">
                  <textarea required rows={4} placeholder="How can Zied help you?" className="w-full p-5 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-white/20 focus:outline-none focus:border-cyan-500/50 focus:bg-cyan-500/5 transition-all resize-none"></textarea>
                </div>
              </div>
