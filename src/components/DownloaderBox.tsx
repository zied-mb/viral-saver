...
const DownloaderBox: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-5">
              ...
              >
                <div className="flex flex-col md:flex-row items-center gap-6 p-6 sm:p-10">
                  ...
                  <div className="flex-1 text-center md:text-left space-y-3">
                    <span className="px-2 py-0.5 rounded text-[9px] font-black bg-red-500/10 text-red-500 uppercase tracking-widest border border-red-500/10">Restricted</span>
                    <h3 className="text-xl sm:text-2xl font-black text-white uppercase italic">PRIVATE CONTENT <span className="text-red-600/90">DETECTED</span></h3>
                    <p className="text-white/40 text-sm leading-relaxed">This account is private. Please make sure the link is public to access their content. 🛡️</p>
                  </div>
                </div>
              </motion.div>
            )}
      ...
      {/* ── Result Section (Ad is now INSIDE ResultCard) ── */}
      <AnimatePresence>
        {result && !loading && (
          <motion.div 
            ...
            className="space-y-6"
          >
            {/* 🎯 الإشهار يظهر توه داخل الـ ResultCard مباشرة */}
